...
open class TabbedPager(
    ...
    private class PageState(
        ...
        override fun toString() = "PageState($caption, disabled=$disabled, content:${content.javaClass.simpleName}, fixedContent:${fixedContent?.javaClass?.simpleName})"
    }
    ...
    private class LinkedScrollPane(
        ...
        class LinkedFlickScrollListener(val stdFlickListener: ActorGestureListener, val linkedScrollPane: LinkedScrollPane):
    ...
    init {
        val screen = (if (QuantumWerewolfGame.isCurrentInitialized()) QuantumWerewolfGame.Current.screen else null)
    ...
    fun askForPassword(secretHashCode: Int = 0) {
        ...
        if (!QuantumWerewolfGame.isCurrentInitialized() || askPasswordLock || deferredSecretPages.isEmpty()) return
        ...
        PassPopup(QuantumWerewolfGame.Current.screen!!, {
            addDeferredSecrets()
        }, {
